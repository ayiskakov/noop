...
it a question. The daily update check reads one public GitHub URL and can be switched off.
...
Both are user-initiated actions. See [PRIVACY_SECURITY.md](PRIVACY_SECURITY.md).
