...
final class Collector {
    ...
    /// Strap family for the LIVE decode path: 5/MG parses the puffin envelope. Set by
    /// BLEManager.configureCollectorFamily alongside an identity clockRef — 5/MG live timestamps are
    /// already real-unix seconds.
