...
/// a newly-landed layout. These are three REAL v25 records a pre-v25 build had
...
final class RawHistoryArchiveReplayTests: XCTestCase {
    ...
    func testReplayThrowsWhenStoreFailsSoGateCanHold() async throws {
        ...
        if case .failed = archive.archive([frame], trim: 70476, family: .whoop5) {
    ...
    func testArchiveAndDirectoryUseBackgroundReadableProtection() throws {
        ...
        guard case .written(count: 1) = archive.archive([frame], trim: 1, family: .whoop5) else {
