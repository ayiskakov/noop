...
strap (5.0 / MG). For protocol or analytics changes, point to the test
...
- [ ] The app targets build if I touched app-target Swift (`xcodebuild … build`; default CI does not compile them)
